...
function buildLevel()
{
    ...
    $.each(objLevelLibrary['level' + objPlayer.nextLevel].levelEntities, function()
    {
        ...
        else
        {
            ...
            if(this.entityName == 'pitfall')
            {
                objLevel.objPitfalls['entity' + objLevel.intEntityCounter] = objLevel.objEntities['entity' + objLevel.intEntityCounter];
            }
            else if(this.entityName == 'tombstoneBug')
            {
...
function renderLevel()
{
    if(objGame.gamePaused == false)
    {
        ...
        for(var key in objLevel.objEntities)
        {
            ...
            if(objLevel.objEntities[key].assetName != 'pitfall' && objLevel.objEntities[key].assetName != 'tombstoneBug')
            {
