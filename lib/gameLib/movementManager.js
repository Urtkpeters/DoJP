...
function buildMovement(whichMovement, speed)
{
    var objMovements =
    {
        entityBullet: buildEntityBullet(speed),
        notepad0: buildNotepad0Movement(speed),
        notepadplusplus0: buildNotepadPlusPlus0Movement(speed),
        notepadplusplus1: buildNotepadPlusPlus1Movement(speed),
        far0: buildFar0Movement(speed),
        eclipse0: buildEclipse0Movement(speed),
        eclipse1: buildEclipse1Movement(speed),
        eclipse2: buildEclipse2Movement(speed),
        eclipse3: buildEclipse3Movement(speed),
        eclipse4: buildEclipse4Movement(speed),
        dreamweaver0: buildDreamweaver0Movement(speed),
        muleStudio0: buildMuleStudio0Movement(speed),
        intelliJ0: buildIntelliJ0Movement(speed),
        intelliJ1: buildIntelliJ1Movement(speed),
        intelliJ2: buildIntelliJ2Movement(speed),
        netbeans0: buildNetbeans0Movement(speed),
        netbeans1: buildNetbeans1Movement(speed),
        floor: buildFloorMovement(speed),
        pitfall: buildFloorMovement(speed),
        stationary: buildStationaryMovement(speed),
        leftSwoop: buildLeftSwoopMovement(speed),
        rightSwoop: buildRightSwoopMovement(speed),
        leftSimpleZigZag: buildLeftSimpleZigZagMovement(speed),
        rightSimpleZigZag: buildRightSimpleZigZagMovement(speed),
        leftBox: buildLeftBoxMovement(speed),
        rightBox: buildRightBoxMovement(speed),
        leftX: buildLeftXMovement(speed),
        rightX: buildRightXMovement(speed),
        leftBackAndForth: buildLeftBackAndForthMovement(speed),
        rightBackAndForth: buildRightBackAndForthMovement(speed),
        centerBoxes: buildCenterBoxesMovement(speed),
        tombstone: buildTombstoneMovement(speed)
    };

    return objMovements[whichMovement];
}
