...
function buildSplashMenu()
{
    ...
    objNewMenu.objLogo = objUILibrary.legendLogo.objImage;
...
function buildTitleMenu()
{
    ...
    {
        if(objNewMenu.activeMenu == 0 && objGame.showDemo)
        {
            objNewMenu.activeMenu = 3;
        }
        else if(objNewMenu.activeMenu == 0 && !objGame.showDemo)
        {
    ...
    {
        if(objNewMenu.activeMenu == 2 && !objGame.showDemo)
        {
            objNewMenu.activeMenu = 0;
        }
        else if(objNewMenu.activeMenu == 3)
        {
            objNewMenu.activeMenu = 0;
        }
        else
...
function buildVictoryMenu()
{
    ...
    if(objPlayer.nextLevel > 19 && objPlayer.nextLevel != 98)
    {
...
function buildShopMenu()
{
    ...
    [
        [
            ...
            {itemName: 'Capsule', itemCode: 'capsule', cost: 200, itemType: 'consumable', iconImage: objUILibrary.capsuleIcon.objImage, quantityDescription: 'On Hand: ', itemDescription: 'Drink one of these for some pep in your step'},
        ...
        [
            {itemName: 'Notepad', itemCode: 'notepad', cost: 600, incrementCost: 60,  itemType: 'IDE', iconImage: objUILibrary.notepadIcon.objImage, quantityDescription: 'Version: ', itemDescription: 'All developers start somewhere'},
            ...
            {itemName: 'Far', itemCode: 'far', cost: 600, incrementCost: 60, itemType: 'IDE', iconImage: objUILibrary.farIcon.objImage, quantityDescription: 'Version: ', itemDescription: 'Multi-use and small but loved by a die-hard crowd.'}
        ],
        [
            {itemName: 'Dreamweaver', itemCode: 'dreamweaver', cost: 1000, incrementCost: 100, itemType: 'IDE', iconImage: objUILibrary.dreamweaverIcon.objImage, quantityDescription: 'Version: ', itemDescription: 'Very good at one thing but not good for much else'},
            {itemName: 'Netbeans', itemCode: 'netbeans', cost: 1000, incrementCost: 100, itemType: 'IDE', iconImage: objUILibrary.netbeansIcon.objImage, quantityDescription: 'Version: ', itemDescription: 'Not as flexible as others but not as focused as some.'},
            {itemName: 'Mule Studio', itemCode: 'muleStudio', cost: 1400, incrementCost: 140, itemType: 'IDE', iconImage: objUILibrary.muleStudioIcon.objImage, quantityDescription: 'Version: ', itemDescription: 'Great at tackling a single focus with a variety of tools'}
        ],
        [
            {itemName: 'Eclipse', itemCode: 'eclipse', cost: 1400, incrementCost: 140, itemType: 'IDE', iconImage: objUILibrary.eclipseIcon.objImage, quantityDescription: 'Version: ', itemDescription: 'Multi-faceted able to tackle a wide range of problems'},
            {itemName: 'IntelliJ', itemCode: 'intelliJ', cost: 1400, incrementCost: 140, itemType: 'IDE', iconImage: objUILibrary.intelliJIcon.objImage, quantityDescription: 'Version: ', itemDescription: 'Extensible. Flexible.'}
        ]
    ];
    ...
    for(var i = 0; i < objNewMenu.aryItems.length; i++)
    {
        for(var j = 0; j < objNewMenu.aryItems[i].length; j++)
        {
            ...
            if(objNewMenu.aryItems[i][j].itemType == 'consumable' && objNewMenu.aryItems[i][j].itemCode == 'capsule')
            {
                objNewMenu.aryItems[i][j].cost += (objPlayer.capsule * 50);
            }
    ...
    objNewMenu.pressedJ = function()
    {
        if(objPlayer.purchase(objNewMenu.aryItems[objNewMenu.subMenu][objNewMenu.activeMenu].itemCode, objNewMenu.aryItems[objNewMenu.subMenu][objNewMenu.activeMenu].cost, objNewMenu.aryItems[objNewMenu.subMenu][objNewMenu.activeMenu].itemType))
        {
            ...
            if(objNewMenu.aryItems[objNewMenu.subMenu][objNewMenu.activeMenu].itemCode == 'capsule')
            {
                objNewMenu.aryItems[objNewMenu.subMenu][objNewMenu.activeMenu].cost += 50;
            }
...
function buildExplanationMenu()
{
    ...
    objNewMenu.capsule = objUILibrary.capsuleIcon.objImage;
    ...
    objNewMenu.render = function()
    {
        ...
        else if(objNewMenu.slide == 1)
        {
            ...
            objCanvas.context.font = '22px Arial';
            objCanvas.context.fillText('This is you. Developer of Legend.', 400, 300);
        ...
        else if(objNewMenu.slide == 4)
        {
            ...
            objCanvas.context.fillText('Capsule', 390, 360);
        ...
        else if(objNewMenu.slide == 5)
        {
            ...
            objCanvas.context.fillText('Capsule', 390 + (275 * (objNewMenu.moveCounter / 100)), 360);
