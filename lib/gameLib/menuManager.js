...
function buildTitleMenu()
{
    ...
    objNewMenu.render = function()
    {
        ...
        if(!objGame.loggedIn && objNewMenu.activeMenu != 1)
        {
            objCanvas.context.fillStyle = '#6c6c6f';
        }
        else if(!objGame.loggedIn && objNewMenu.activeMenu == 1)
        {
...
function buildVictoryMenu()
{
    ...
    console.log('Level ' + objPlayer.nextLevel.toString() + ': ' + objLevel.multiplier.toString());
    ...
    objLevel.earnings = (objLevel.earnings * objLevel.multiplier);
    ...
    objNewMenu.render = function()
    {
        ...
        else if(objNewMenu.slide == 2)
        {
            ...
            objCanvas.context.fillText('time.multiplier == ' + objLevel.multiplier.toString(), 400, 355);
        ...
        else if(objNewMenu.slide == 3)
        {
            ...
            objCanvas.context.font = '18px Arial';
            objCanvas.context.fillText('player.budget == ' + (Math.round(objPlayer.earnings + (objLevel.earnings * objLevel.multiplier))).toString(), 400, 400);
            objCanvas.context.fillText('player.score == ' + (Math.round(objPlayer.score + (objLevel.earnings * objLevel.multiplier))).toString(), 400, 425);
    ...
    objNewMenu.pressedSpace = function()
    {
        ...
        objPlayer.earnings += objLevel.earnings * objLevel.multiplier;
        objPlayer.score += objLevel.earnings * objLevel.multiplier;
    };
...
function buildShopMenu()
{
    ...
    [
        ...
        [
            ...
            {itemName: 'Far', itemCode: 'far', cost: 800, incrementCost: 80, itemType: 'IDE', iconImage: objUILibrary.farIcon.objImage, quantityDescription: 'Version: ', itemDescription: 'Multi-use and small but loved by a die-hard crowd.'}
        ],
        [
            ...
            {itemName: 'Mule Studio', itemCode: 'muleStudio', cost: 1200, incrementCost: 120, itemType: 'IDE', iconImage: objUILibrary.muleStudioIcon.objImage, quantityDescription: 'Version: ', itemDescription: 'Great at tackling a single focus with a variety of tools'},
        ...
        [
            {itemName: 'Eclipse', itemCode: 'eclipse', cost: 2000, incrementCost: 200, itemType: 'IDE', iconImage: objUILibrary.eclipseIcon.objImage, quantityDescription: 'Version: ', itemDescription: 'Multi-faceted able to tackle a wide range of problems'},
            {itemName: 'IntelliJ', itemCode: 'intelliJ', cost: 2000, incrementCost: 200, itemType: 'IDE', iconImage: objUILibrary.intelliJIcon.objImage, quantityDescription: 'Version: ', itemDescription: 'Extensible. Flexible.'}
        ]
    ];
    ...
    objNewMenu.render = function()
    {
        ...
        objCanvas.context.fillText('Next: Level ' + objMenu.levelNumber + ' - ' + objLevelLibrary['level' + objMenu.levelNumber].levelName, 770, 530);

        objCanvas.context.font = '18px Arial';
        objCanvas.context.fillText('Proceed to Next Level - Press Space >', 780, 550);
    ...
    objNewMenu.pressedJ = function()
    {
        if(objPlayer.purchase(objNewMenu.aryItems[objNewMenu.subMenu][objNewMenu.activeMenu].itemCode, objNewMenu.aryItems[objNewMenu.subMenu][objNewMenu.activeMenu].cost, objNewMenu.aryItems[objNewMenu.subMenu][objNewMenu.activeMenu].itemType))
        {
            ...
            {
                objNewMenu.aryItems[objNewMenu.subMenu][objNewMenu.activeMenu].cost += 20;
            }
