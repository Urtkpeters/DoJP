...
function buildVictoryMenu()
{
    ...
    if(objLevel.multiplier < 10000)
    {
        objLevel.multiplier = 1.4;
    }
    else if(objLevel.multiplier < 15000)
    {
        objLevel.multiplier = 1.2;
    }
    else if(objLevel.multiplier < 20000)
    {
        objLevel.multiplier = 1.0;
    }
    else if(objLevel.multiplier < 25000)
    {
    ...
    objNewMenu.render = function()
    {
        ...
        else if(objNewMenu.slide == 2)
        {
            ...
            objCanvas.context.fillText('time.multiplier == ' + objLevel.multiplier.toString(), 400, 450);
