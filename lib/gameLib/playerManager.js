...
function buildPlayer()
{
    objPlayer.newGame = function()
    {
        ...
        {
            active: 'notepad',
            notepad:            {level: 1, bullets: 1, damage: 8000,  cooldown: 1, speed: 100, damageLevel: 6, cooldownLevel: 2, speedLevel: 3},
            notepadplusplus:    {level: 0, bullets: 2, damage: 8, cooldown: 40, speed: 100, damageLevel: 4, cooldownLevel: 2, speedLevel: 1},
            far:                {level: 0, bullets: 1, damage: 8, cooldown: 40, speed: 300, damageLevel: 6, cooldownLevel: 1, speedLevel: 3},
            eclipse:            {level: 0, bullets: 5, damage: 4, cooldown: 60, speed: 70, damageLevel: 2, cooldownLevel: 1, speedLevel: 2},
            dreamweaver:        {level: 0, bullets: 1, damage: 3,  cooldown: 22, speed:  25, damageLevel: 3, cooldownLevel: 0, speedLevel: 1},
            muleStudio:         {level: 0, bullets: 1, damage: 12, cooldown: 40, speed: 100, damageLevel: 12, cooldownLevel: 0, speedLevel: 1},
            intelliJ:           {level: 0, bullets: 3, damage: 6, cooldown: 40, speed: 100, damageLevel: 3, cooldownLevel: 1, speedLevel: 2},
            netbeans:           {level: 0, bullets: 2, damage: 8, cooldown: 40, speed: 100, damageLevel: 4, cooldownLevel: 1, speedLevel: 2}
        };
