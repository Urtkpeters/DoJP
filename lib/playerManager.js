...
function buildPlayer()
{
    ...
    objPlayer.throw = function()
    {
        if(objPlayer.batteryPower >= objPlayer.batteryMax)
        {
            objLevel.laptop = buildEntity('laptop','player','notepad0', 0, 'temp', 0);
            objPlayer.batteryPower = 0;
    ...
    objPlayer.fire = function()
    {
        if(objPlayer.fireRecharge >= objPlayer.IDE[objPlayer.IDE.active].cooldown)
        {
            ...
            {
                objLevel.objBullets['bullet' + objLevel.intBulletCounter] = buildEntity('bullet','player',objPlayer.IDE.active + '0', 0, 'temp', 0);
                objLevel.objBullets['bullet' + objLevel.intBulletCounter + 1] = buildEntity('bulletUpperLeft','player',objPlayer.IDE.active + '1', 0, 'temp', 0);
                objLevel.objBullets['bullet' + objLevel.intBulletCounter + 2] = buildEntity('bulletUpperRight','player',objPlayer.IDE.active + '2', 0, 'temp', 0);
                objLevel.objBullets['bullet' + objLevel.intBulletCounter + 3] = buildEntity('bulletLeft','player',objPlayer.IDE.active + '3', 0, 'temp', 0);
                objLevel.objBullets['bullet' + objLevel.intBulletCounter + 4] = buildEntity('bulletRight','player',objPlayer.IDE.active + '4', 0, 'temp', 0);
                objLevel.intBulletCounter += 5;
                objSounds.fire.play();
            }
            else if(objPlayer.IDE.active == 'muleStudio')
            {
                objLevel.objBullets['bullet' + objLevel.intBulletCounter] = buildEntity('bulletBig','player',objPlayer.IDE.active + '0', 0, 'temp', 0);
            ...
            {
                objLevel.objBullets['bullet' + objLevel.intBulletCounter] = buildEntity('bulletBig','player',objPlayer.IDE.active + '0', 0, 'temp', 0);
                objLevel.objBullets['bullet' + objLevel.intBulletCounter + 1] = buildEntity('bulletBig','player',objPlayer.IDE.active + '1', 0, 'temp', 0);
            ...
            else
            {
                ...
                {
                    objLevel.objBullets['bullet' + objLevel.intBulletCounter] = buildEntity('bullet','player',objPlayer.IDE.active + i.toString(), 0, 'temp', 0);
                    objLevel.intBulletCounter += 1;
                    objSounds.fire.play();
                }
            }
